...
foreach(_cmake_expected_target IN ITEMS PcapPlusPlus::light_pcapng PcapPlusPlus::Packet++ PcapPlusPlus::Pcap++ PcapPlusPlus::Common++)
...
set_target_properties(PcapPlusPlus::Pcap++ PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/pcapplusplus"
  INTERFACE_LINK_LIBRARIES "PcapPlusPlus::Common++;PcapPlusPlus::Packet++;\$<\$<BOOL:OFF>:PF_RING::PF_RING>;\$<\$<BOOL:OFF>:DPDK::DPDK>;\$<\$<BOOL:OFF>:BPF::BPF>;PCAP::PCAP;Threads::Threads"
)
